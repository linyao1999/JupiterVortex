...
# Problem
problem = d3.EVP([q1, q2, psi1, psi2, tau_psi1, tau_psi2], eigenvalue=s, namespace=locals())
problem.add_equation("q1 - (lap(psi1) - F1 * (psi1 - psi2)) + lift(tau_psi1) = 0")
problem.add_equation("q2 - (lap(psi2) + F2 * (psi1 - psi2)) + lift(tau_psi2) = 0")
...
for kphi in range(5,6):
    ...
    for axi in ax.flatten():
        ...
        axi.set_axis_off()
    fig.tight_layout()
    fig.savefig(f'phi_m{kphi}.png', dpi=200)
