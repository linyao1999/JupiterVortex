...
snapshots_dir = f'snapshots_Fhigh_U_{U}_lapNu_nonlinear_4var_4tau_2taup_test'
...
# Analysis
snapshots = solver.evaluator.add_file_handler(snapshots_dir, sim_dt=timestep*100, max_writes=500, mode='overwrite')
