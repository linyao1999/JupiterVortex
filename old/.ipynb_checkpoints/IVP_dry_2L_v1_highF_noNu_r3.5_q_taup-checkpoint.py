...
snapshots_dir = f'snapshots_Fhigh_U_{U}_2tau_noNu_q_taup'
...
problem.add_equation("q1 - (lap(psi1) - F1 * (psi1 - psi2)) + lift(tau1,-1) = 0")
problem.add_equation("q2 - (lap(psi2) + F2 * (psi1 - psi2)) + lift(tau2,-1) = 0")
...
# problem.add_equation("lap(psi1)(r=a_norm) + tau_p1 = 0") # double check? it is the same as lap(psi1)(r=a_norm) = 0
# problem.add_equation("lap(psi2)(r=a_norm) + tau_p2 = 0")
