...
if prob_class == 'EVP':
    ...
    problem = d3.IVP([psi1, psi2, tau_psi1, tau_psi2, tau_q1, tau_q2], namespace=locals())
    
problem.add_equation("dt(q1) + u1@grad(Q1) + U1@grad(q1) + lift(tau_psi1) - nu*lap(q1) + lift(tau_q1)= 0")
problem.add_equation("dt(q2) + u2@grad(Q2) + U2@grad(q2) + lift(tau_psi2) - nu*lap(q2) + lift(tau_q2)= 0")
