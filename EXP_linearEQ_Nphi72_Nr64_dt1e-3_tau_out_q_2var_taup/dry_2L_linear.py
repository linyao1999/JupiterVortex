...
if prob_class == 'EVP':
    ...
    if init_pattern == 'evp_max_growth':
        ...
        checkpoint_file = './checkpoints_evp/checkpoints_evp_s1.h5'
    elif init_pattern == 'random':
        snapshots_file = 'snapshots_rdm'
        checkpoint_path = 'checkpoints_rdm'
        checkpoint_file = './checkpoints_rdm/checkpoints_rdm_s1.h5'
...
# Problem
if prob_class == 'EVP':
    problem = d3.EVP([psi1, psi2, tau_psi1, tau_psi2, taup1, taup2], eigenvalue=s, namespace=locals())
elif prob_class == 'IVP':
    problem = d3.IVP([psi1, psi2, tau_psi1, tau_psi2, taup1, taup2], namespace=locals())
    
problem.add_equation("dt(q1) + u1@grad(Q1) + U1@grad(q1) + lift(tau_psi1) + taup1 = 0")
problem.add_equation("dt(q2) + u2@grad(Q2) + U2@grad(q2) + lift(tau_psi2) + taup2 = 0")
