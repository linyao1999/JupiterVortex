...
problem.add_equation("q2 - (lap(psi2) + F2 * (psi1 - psi2)) + lift(tau3,-1) = 0")
...
# problem.add_equation("dr(q1)(r=a_norm) = 0") # double check? it is the same as lap(psi1)(r=a_norm) = 0
# problem.add_equation("dr(q2)(r=a_norm) = 0")
