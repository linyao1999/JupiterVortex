...
snapshots_dir = f'/pscratch/sd/l/linyaoly/GFD_Polar_vortex/ddloutput/snapshots_F51_U_{U}_linear_noNu_2var'
...
# Analysis
snapshots = solver.evaluator.add_file_handler(snapshots_dir, sim_dt=timestep*200, max_writes=500, mode='overwrite')
